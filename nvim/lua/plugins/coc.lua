-- Execute a CocUpdate after each Lazy update
vim.api.nvim_create_autocmd("User", {
  desc = 'Update coc extensions after LazyUpdate',
  group = vim.api.nvim_create_augroup("CocUpdate", {}),
  pattern = 'LazyUpdate',
  command = 'CocUpdate',
})
...
return {
  ...
  function! CheckBackspace() abort
    ...
    if telescopeAvailable then
      ...
      vim.keymap.set('n', 'gr', ':Telescope coc references path_display={\'tail\'}<cr>',
